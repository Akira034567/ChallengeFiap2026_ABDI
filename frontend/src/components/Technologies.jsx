...
const categories = [
  ...
  {
    label: 'Frontend & Mobile (Implementação futura)',
    icon: <Globe size={18} />,
    color: '#00c8e8',
    techs: [
  ...
  {
    label: 'IoT & Automação (Implementação futura)',
    icon: <Wifi size={18} />,
    color: '#f44336',
    techs: [
  ...
  {
    label: 'Infraestrutura & Cloud (Implementação futura)',
    icon: <Layers size={18} />,
    color: '#4caf50',
    techs: [
  ...
  {
    label: 'Dados & Relatórios (Implementação futura)',
