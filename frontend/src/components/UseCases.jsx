...
const cases = [
  {
    ...
    impact: 'Redução de x nos registros de inconformidade de EPI em período de 30 dias.',
    color: '#f44336',
  ...
  },
  {
    ...
    impact: 'Cobertura de 100% da obra com x câmeras, substituindo equipe de fiscais.',
    color: '#ff6d00',
  ...
  },
  {
    ...
    impact: 'Tempo de verificação de EPI reduzido de x minutos (manual) para <1 segundo.',
    color: '#00c8e8',
